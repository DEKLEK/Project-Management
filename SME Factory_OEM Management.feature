Feature: SME Factory_OEM Management
  ...
  Scenario: TC-SME-406 : ทดสอบการใช้งาน Pagination Control โดยทำการเปลี่ยน Limit ในหน้า New Company Edit - User (Edit)
    When เลือก จำนวน/Pageที่ต้องการ4

  Scenario: TC-SME-407 : ทดสอบการใช้งาน ไอคอนมากกว่าเปลี่ยนหน้า ในหน้า New Company Edit - User (Edit)
    When กด ไอคอน >4

  Scenario: TC-SME-408 : ทดสอบการใช้งาน ไอคอนน้อยเปลี่ยนหน้า ในหน้า New Company Edit - User (Edit)
    When กด ไอคอน <4
  # Scenario: TC-SME-409 : ทดสอบปุ่ม Delete ในหน้า New Company Edit - User (Edit)
  #   When คลิกปุ่มจุด 3 จุด
  #   When คลิกปุ่ม Delete
  # Scenario: TC-SME-410 : ทดสอบปุ่ม Cancel ในหน้า Warning (Edit)
  #   When คลิกปุ่ม Cancel
  # Scenario: TC-SME-411 : ทดสอบปุ่ม Confirm ในหน้า Warning (Edit)
  #   When คลิกปุ่มจุด 3 จุด
  #   When คลิกปุ่ม Delete
  #   When คลิกปุ่ม Save
  # Scenario: TC-SME-412 : ทดสอบกด User Group (Edit)
  #   When คลิก User
  # Scenario: TC-SME-413 : ทดสอบการปุ่ม Add .ในหน้า New Company Edit - User Group Add (Edit)
  #   When คลิกปุ่มAdd
  # Scenario: TC-SME-414 : ทดสอบปุ่ม Cancel ในหน้า New Company Edit - User Group Edit (Edit)
  #   When คลิกปุ่ม Cancel
  # Scenario: TC-SME-415 : ทดสอบปุ่ม Cancel ในหน้า Warning (Edit)
  #   When คลิกปุ่ม Cancel
  # Scenario: TC-SME-416 : ทดสอบปุ่ม Confirm ในหน้า Warning (Edit)
  #   When คลิกปุ่ม Cancel
  #   When คลิกปุ่ม Confirm
  # Scenario: TC-SME-417 : ทดสอบการกรอกข้้อมูล User Groupในหน้า New Company Edit - User Group Add(Edit)
  #   When คลิกปุ่มAdd
  #   When กรอกข้อมูล Fill : User Group Name
  #   When กรอกข้อมูล Fill : Select OEM
  #   When กรอกข้อมูล Fill : Remark
  # Scenario: TC-SME-418 : ทดสอบการเลือกข้้อมูล Select Userในหน้า New Company Edit - User Group Add(Edit)
  #   When เลือกข้อมูล Select User
  # Scenario: TC-SME-419 : ทดสอบการกรอกข้อมูลใน Global Searchด้วยข้อมูลที่แสดงในตาราง Feature ใน Permission Management (Edit)
  #   When กรอกข้อมูล ในช่องกรอก
  # Scenario: TC-SME-420 : ทดสอบการ Search ข้อมูล Feature ใน Permission Management (Edit)
  #   When คลิกปุ่ม Search
  # Scenario: TC-SME-421 : ทดสอบการ Clear ข้อมูลค้นหา Feature ใน Permission Management (Edit)
  #   When คลิกปุ่ม Clear
  # Scenario: TC-SME-422 : ทดสอบกด Module & Menu (Edit)
  #   When คลิก Module & Menu
  # Scenario: TC-SME-423 : ทดสอบกด Feature (Edit)
  #   When คลิก Feature
  # Scenario: TC-SME-424 : ทดสอบกดเลือก ข้อมูล ใน Module & Menu(Edit)
  #   When คลิก Module & Menu
  #   When กด เลือกข้อมูล
  # Scenario: TC-SME-425 : ทดสอบกดเลือก Select All ใน Module & Menu (Edit)
  #   When คลิก Module & Menu
  #   When กด เลือกข้อมูล
  # Scenario: TC-SME-426 : ทดสอบปุ่มไอคอน แว่นขยาย ใน Module & Menu (Edit)
  #   When คลิกปุ่มแว่นขยาย
  # Scenario: TC-SME-427 : ทดสอบการกรอกข้อมูลใน Global Searchด้วยข้อมูลที่แสดงในตาราง Module & Menu ใน  หน้าPermission Management (Edit)
  #   When กรอกข้อมูล ในช่องกรอก
  # Scenario: TC-SME-428 : ทดสอบปุ่ม Search (Module & Menu) (Edit)
  #   When กดปุ่ม Search
  # Scenario: TC-SME-429 : ทดสอบปุ่ม Reset (Module & Menu) (Edit)
  #   When กดปุ่ม Reset
  # Scenario: TC-SME-430 : ทดสอบปุ่ม Close (Module & Menu) (Edit)
  #   When กดปุ่ม Close
  # Scenario: TC-SME-431 : ทดสอบกดเลือก ข้อมูล ใน  Feature (Edit)
  #   When คลิก  Feature
  #   When กด เลือกข้อมูล
  # Scenario: TC-SME-432 : ทดสอบกดเลือก Select All ใน  Feature (Edit)
  #   When คลิก  Feature
  #   When กด เลือกข้อมูล
  # Scenario: TC-SME-433 : ทดสอบปุ่มไอคอน แว่นขยาย ใน  Feature (Edit)
  #   When คลิกปุ่มแว่นขยาย
  # Scenario: TC-SME-434 : ทดสอบการกรอกข้อมูลใน Global Searchด้วยข้อมูลที่แสดงในตาราง Feature ใน  หน้าPermission Management (Edit)
  #   When กรอกข้อมูล ในช่องกรอก
  # Scenario: TC-SME-435 : ทดสอบปุ่ม Search ( Feature) (Edit)
  #   When กดปุ่ม Search
  # Scenario: TC-SME-436 : ทดสอบปุ่ม Reset ( Feature) (Edit)
  #   When กดปุ่ม Reset
  # Scenario: TC-SME-437 : ทดสอบปุ่ม Close ( Feature) (Edit)
  #   When กดปุ่ม Close
  # Scenario: TC-SME-438 : ทดสอบปุ่ม Savel ในหน้า New Company Edit - User Group Edit (Edit)
  #   When คลิกปุ่ม Save
  # Scenario: TC-SME-439 : ทดสอบปุ่ม Cancel ในหน้า Warning (Edit)
  #   When คลิกปุ่ม Cancel
  # Scenario: TC-SME-440 : ทดสอบปุ่ม Confirm ในหน้า Warning (Edit)
  #   When คลิกปุ่ม Save
  #   When คลิกปุ่ม Confirm
  # Scenario: TC-SME-441 : ทดสอบกดจุด 3 จุด (Edit) New Company Edit - User Group
  #   When คลิกจุด 3 จุด4
  # Scenario: TC-SME-442 : ทดสอบกดปุ่ม Edit (Edit) New Company Edit - User Group
  #   When คลิกปุ่ม Edit
  # Scenario: TC-SME-443 : ทดสอบปุ่ม Cancel ในหน้า New Company Edit - User Group Edit (Edit)
  #   When คลิกปุ่ม Cancel
  # Scenario: TC-SME-444 : ทดสอบปุ่ม Cancel ในหน้า Warning (Edit)
  #   When คลิกปุ่ม Cancel
  # Scenario: TC-SME-445 : ทดสอบปุ่ม Confirm ในหน้า Warning (Edit)
  #   When คลิกปุ่ม Cancel
  #   When คลิกปุ่ม Confirm
  # Scenario: TC-SME-446 : ทดสอบการกรอกข้้อมูล User Groupในหน้า New Company Edit - User Group Edit(Edit)
  #   When คลิกจุด 3 จุด5
  #   When คลิกปุ่ม Edit
  #   When แก้ไขข้อมูล Fill : User Group Name
  #   When แก้ไขข้อมูล Fill : Select OEM
  #   When แก้ไขข้อมูล Fill : Remark
  # Scenario: TC-SME-447 : ทดสอบการเลือกข้้อมูล Select Userในหน้า New Company Edit - User Group Edit(Edit)
  #   When เลือกข้อมูล Select User
  # Scenario: TC-SME-448 : ทดสอบปุ่ม Savel ในหน้า New Company Edit - User Group Edit (Edit)
  #   When คลิกปุ่ม Save
  # Scenario: TC-SME-449 : ทดสอบปุ่ม Cancel ในหน้า Warning (Edit)
  #   When คลิกปุ่ม Cancel
  # Scenario: TC-SME-450 : ทดสอบปุ่ม Confirm ในหน้า Warning (Edit)
  #   When คลิกปุ่ม Save
  #   When คลิกปุ่ม Confirm
  # Scenario: TC-SME-451 : ทดสอบการกรอกข้อมูลใน Global Searchด้วยข้อมูลที่แสดงในตาราง ในหน้า New Company Edit - User Group (Edit)
  #   When กรอกข้อมูลค้นหา
  # Scenario: TC-SME-452 : ทดสอบการ Search ข้อมูล ในหน้า New Company Edit - User Group (Edit)
  #   When คลิกปุ่มค้นหา
  # Scenario: TC-SME-453 : ทดสอบการ Clear ข้อมูลค้นหา ในหน้า New Company Edit - User Group (Edit)
  #   When คลิกปุ่ม Clear
  # Scenario: TC-SME-454 : ทดสอบการ Filter ข้อมูล ในหน้า New Company Edit - User Group (Edit)
  #   When กด Filter ข้อมูล
  # Scenario: TC-SME-455 : ทดสอบไอคอน จัดเรียงข้อมูล (User Group) ใน New Company Edit - User Group (Edit)
  #   When กดไอคอน จัดเรียงข้อมูล
  # Scenario: TC-SME-456 : ทดสอบไอคอน ค้นหาข้อมูล (User Group) ใน New Company Edit - User Group (Edit)
  #   When กดไอคอน กรองข้อมูล
  # Scenario: TC-SME-457 : ทดสอบการกรอกข้อมูลใน Global Search(User Group) ใน New Company Edit - User Group (Edit)
  #   When กรอกข้อมูลค้นหา
  # Scenario: TC-SME-458 : ทดสอบปุ่ม Search (User Group) ใน New Company Edit - User Group (Edit)
  #   When กดปุ่ม Search
  # Scenario: TC-SME-459 : ทดสอบปุ่ม Reset (User Group) ใน New Company Edit - User Group (Edit)
  #   When กดปุ่ม Reset
  # Scenario: TC-SME-460 : ทดสอบปุ่ม Close (User Group) ใน New Company Edit - User Group (Edit)
  #   When กดปุ่ม Close
  # Scenario: TC-SME-461 : ทดสอบไอคอน จัดเรียงข้อมูล (OEM) ใน New Company Edit - User Group (Edit)
  #   When กดไอคอน จัดเรียงข้อมูล
  # Scenario: TC-SME-462 : ทดสอบปุ่มกรองข้อมูล  (OEM) ใน New Company Edit - User Group (Edit)
  #   When กดไอคอน กรองข้อมูล
  # Scenario: TC-SME-463 : ทดสอบการกรอกข้อมูลใน Global Search(OEM) ใน New Company Edit - User Group (Edit)
  #   When กรอกข้อมูลค้นหา
  # Scenario: TC-SME-464 : ทดสอบการเลือกข้อมูล (OEM) ใน New Company Edit - User Group (Edit)
  #   When เลือกข้อมูล
  # Scenario: TC-SME-465 : ทดสอบปุ่ม Search (OEM) ใน New Company Edit - User Group (Edit)
  #   When กดปุ่ม Search
  # Scenario: TC-SME-466 : ทดสอบปุ่ม Reset (OEM) ใน New Company Edit - User Group (Edit)
  #   When กดปุ่ม Reset
  # Scenario: TC-SME-467 : ทดสอบปุ่ม Close (OEM) ใน New Company Edit - User Group (Edit)
  #   When กดปุ่ม Close
  # Scenario: TC-SME-468 : ทดสอบไอคอน จัดเรียงข้อมูล (Remark) ใน New Company Edit - User Group (Edit)
  #   When กดไอคอน จัดเรียงข้อมูล
  # Scenario: TC-SME-469 : ทดสอบไอคอน ค้นหาข้อมูล (Remark) ใน New Company Edit - User Group (Edit)
  #   When กดไอคอน ค้นหาข้อมูล
  # Scenario: TC-SME-470 : ทดสอบการกรอกข้อมูลใน Global Search(Remark) ใน New Company Edit - User Group (Edit)
  #   When กรอกข้อมูลค้นหา
  # Scenario: TC-SME-471 : ทดสอบปุ่ม Search (Remark)ใน New Company Edit - User Group (Edit)
  #   When กดปุ่ม Search
  # Scenario: TC-SME-472 : ทดสอบปุ่ม Reset (Remark) ใน New Company Edit - User Group (Edit)
  #   When กดปุ่ม Reset
  # Scenario: TC-SME-473 : ทดสอบปุ่ม Close (Remark) ใน New Company Edit - User Group (Edit)
  #   When กดปุ่ม Close
  # Scenario: TC-SME-474 : ทดสอบการใช้งาน Pagination Control โดยทำการเปลี่ยน Limit ในหน้า New Company Edit - User Group (Edit)
  #   When เลือก จำนวน/Pageที่ต้องการ
  # Scenario: TC-SME-475 : ทดสอบการใช้งาน ไอคอนมากกว่าเปลี่ยนหน้า New Company Edit - User Group (Edit)
  #   When กด ไอคอน >
  # Scenario: TC-SME-476 : ทดสอบการใช้งาน ไอคอนน้อยเปลี่ยนหน้า New Company Edit - User Group (Edit)
  #   When กด ไอคอน <
  # Scenario: TC-SME-477 : ทดสอบการปุ่ม View ในหน้า SME Factory - OEM Management
  #   When คลิกจุด 3 จุด6
  #   When คลิกปุ่ม View
  # Scenario: TC-SME-478 : ทดสอบการกด User ในView
  #   When คลิก User
  # Scenario: TC-SME-479 : ทดสอบการกด User Group ในView
  #   When คลิก User Group
  # Scenario: TC-SME-480 : ทดสอบการกด Company ในView
  #   When คลิก Company
  # Scenario: TC-SME-481 : ทดสอบการใช้งาน Pagination Control โดยทำการเปลี่ยน Limit ในหน้า New Company Edit - User
  #   When เลือก จำนวน/Pageที่ต้องการ
  # Scenario: TC-SME-482 : ทดสอบการใช้งาน ไอคอนมากกว่าเปลี่ยนหน้า ในหน้า New Company Edit - User
  #   When กด ไอคอน >
  # Scenario: TC-SME-483 : ทดสอบการใช้งาน ไอคอนน้อยเปลี่ยนหน้าในหน้า New Company Edit - User
  #   When กด ไอคอน <
  # Scenario: TC-SME-484 : ทดสอบปุ่ม Cancel ในView
  #   When คลิกปุ่ม Cancel
  # Scenario: TC-SME-485 : ทดสอบการปุ่ม Sort Menu ในหน้า SME Factory - OEM Management
  #   When เข้าเมนู SME Factory - OEM Management
  #   When คลิกจุด 3 จุด7
  #   When คลิกปุ่ม Sort Menu
  # Scenario: TC-SME-486 : ทดสอบการกรอกข้อมูลใน Global Search ในหน้า Sort Menu
  #   When กรอกข้อมูล ในช่องกรอก
  # Scenario: TC-SME-487 : ทดสอบปุ่มไอคอน ปากา ใน Sort Menu
  #   When คลิกปุ่มไอคอนถังขยะ
  #   When คลิกปุ่ม Cancel
  # Scenario: TC-SME-488 : ทดสอบปุ่ม Cancel ใน Sort Menu
  #   When คลิกปุ่มไอคอนถังขยะ
  #   When คลิกปุ่ม Cancel
  # Scenario: TC-SME-489 : ทดสอบปุ่ม Save ใน Sort Menu
  #   When คลิกปุ่มไอคอนถังขยะ
  #   When คลิกปุ่ม Confirm
  # Scenario: TC-SME-490 : ทดสอบปุ่ม Cancel ใน Warning
  #   When คลิกปุ่มไอคอนถังขยะ
  #   When คลิกปุ่ม Cancel
  # Scenario: TC-SME-491 : ทดสอบปุ่ม Confirm ใน Warning
  #   When คลิกปุ่มไอคอนถังขยะ
  #   When คลิกปุ่ม Confirm
  # Scenario: TC-SME-492 : ทดสอบปุ่ม Status
  #   When คลิกปุ่ม Status
  # Scenario: TC-SME-493 : ทดสอบการปุ่ม Delete ในหน้า SME Factory - OEM Management
  #   When เข้าเมนู SME Factory - OEM Management
  #   When คลิกจุด 3 จุด8
  #   When คลิกปุ่ม Delete
  # Scenario: TC-SME-494 : ทดสอบปุ่ม Cancel ใน Warning
  #   When คลิกปุ่มไอคอนถังขยะ
  #   When คลิกปุ่ม Cancel
  # Scenario: TC-SME-495 : ทดสอบปุ่ม Confirm ใน Warning
  #   When คลิกปุ่มไอคอนถังขยะ
  #   When คลิกปุ่ม Confirm
